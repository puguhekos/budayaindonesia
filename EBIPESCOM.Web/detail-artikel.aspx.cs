...
public partial class detail_artikel : System.Web.UI.Page
{
    ...
    private void BindDetailData()
    {
        ...
        String strQuery = "select id_budaya, nama_budaya, provinsi, jenis_budaya, ket, ket_img, sumber, file_path from budaya where id_budaya=" + id1;
